...
| [0010](0010-analytics-platform-phase5-event-persistence.md) | analytics-platform Phase 5 完遂（Pub/Sub 入口 + 本番イベントの GCS 永続化） | cross-agent (analytics-platform + 稼働中エージェント) | Draft |
